...
$myfile = fopen("demo-right.json", "r") or die("Unable to open input file!");
$myoutfile = fopen("demo-right.json.new", "w") or die("Unable to open output file!");
$myphpfile = fopen("demo-right.json.php.new", "w") or die("Unable to open output file!");
# Write php header
...
rename("demo-right.json.new", "demo-right.json");
rename("demo-right.json.php.new", "demo-right.json.php");
